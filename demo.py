...
# Load
model_path = '/root/autodl-tmp/IC-Light/models/iclight_sd15_fc.safetensors'
...
if __name__ == '__main__':
    ...
    input_fg = utils.cv2_load_rgb('/root/autodl-tmp/qyd/gradio_sam/Interactive-SAM-with-Gradio/cup_rota40.png') # 前景图片
    # prompt = 'handsome man, detailed face, at home, fashion background' # 基本prompt
    # prompt = 'soft light, night, street' # 基本prompt
    # prompt = 'at home, wall background and plants' # 基本prompt
    # prompt = 'kitchen,pot'
    prompt = 'a cup is on a desk, beside group of kids enjoying a cup of tea, remain the original'
    ...
    mask = utils.cv2_load_rgb('/root/autodl-tmp/qyd/gradio_sam/Interactive-SAM-with-Gradio/cup_rota40_mask.png')
    ...
    for i, ic_res in enumerate(results):
        ...
        utils.cv2_save_rgb('./result/test1_cup.png', ic_res)
